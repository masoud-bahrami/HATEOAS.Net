...
namespace HATEOAS.Net.HAL
{
    public partial class EmbeddedResource
    {
        ...
        {
            LinksObjects.Add(new LinkObject(LinkRelations.First) { Links = new List<Link> { link } });
            return this;
        }
        public EmbeddedResource WithFirstLink(string href,string httpVerb, bool? templated = null, string name = "", string type = "", string deprecation = "")
        {

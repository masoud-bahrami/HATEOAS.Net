...
namespace HATEOAS.Net.HAL
{
    public partial class EmbeddedResource
    {
        ...
        {
            LinksObjects.Add(new LinkObject(relation) { Links = new List<Link> { link } });
            return this;
        }
        ...
        {
            LinksObjects.Add(new LinkObject(relation) { Links = new List<Link> { new Link(href,httpVerb, templated, name, type, deprecation) } });
            return this;
        }
    }
}
...
namespace HATEOAS.Net.HAL
{
    public partial class EmbeddedResource
    {
        ...
        {
            LinksObjects.Add(new LinkObject(LinkRelations.Previous) { Links = new List<Link> { link } });
            return this;
        }
        public EmbeddedResource WithPreviousLink(string href, string httpVerb, bool? templated = null, string name = "", string type = "", string deprecation = "")
        {

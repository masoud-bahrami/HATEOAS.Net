...
{
    public class EmbeddedResourceNameNullOrEmptyException : System.Exception
    {
        ...
        /// </summary>
        public EmbeddedResourceNameNullOrEmptyException() : base(MESSAGE)
        {
        }
        ...
        /// </param>
        public EmbeddedResourceNameNullOrEmptyException(string message)
            : base(message)
        {
        }
        ...
        /// The inner exception.
        /// </param>
        public EmbeddedResourceNameNullOrEmptyException(string message, System.Exception innerException)

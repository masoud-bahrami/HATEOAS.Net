...
{
    public class LinkRelationNullExeption : System.Exception
    {
        ...
        /// </summary>
        public LinkRelationNullExeption() : base(MESSAGE)
        {
        }
        ...
        /// </param>
        public LinkRelationNullExeption(string message)
            : base(message)
        {
        }
        ...
        /// The inner exception.
        /// </param>
        public LinkRelationNullExeption(string message, System.Exception innerException)
